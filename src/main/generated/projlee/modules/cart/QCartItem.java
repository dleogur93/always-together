...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = 1384787003L;
    ...
    public final projlee.modules.item.domain.QItem item;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.item = inits.isInitialized("item") ? new projlee.modules.item.domain.QItem(forProperty("item")) : null;
    }
